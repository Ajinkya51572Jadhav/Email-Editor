...
const IconSize = () => {
    ...
    console.log("value ICON SIzse", value);

    return visible ? (
        <Form.Item label="Icon Size:">
            <Input onChange={handleChange} type="text" value={value == undefined ? "5px" : value} />
        </Form.Item>
    ) : null;
};
